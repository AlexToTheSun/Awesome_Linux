...
После скачивания обязательно сверяем SHA-256 каждого файла с хэшем, указанным разработчиками ```Get-FileHash <path-to-iso-file>```. Если все верно - просто скидываем файлы на флешку с установленным Ventoy. Для удобства на флешке можно создавать директории.

Готово, можно пользоваться.
Можно свободно скидывать и удялять с флешки дополнительные образы.
